...
public class MessagesDataProvider extends ContentProvider {
	...
	public static final Uri CONTENT_URI_MESSAGES = Uri.parse("content://com.example.terptradingpostmessaging.provider/messages");
	public static final Uri CONTENT_URI_PROFILE = Uri.parse("content://com.example.terptradingpostmessaging.provider/profile");
	...
	static {
	    ...
	    uriMatcher.addURI("com.example.terptradingpostmessaging.provider", "messages", MESSAGES_ALLROWS);
	    uriMatcher.addURI("com.example.terptradingpostmessaging.provider", "messages/#", MESSAGES_SINGLE_ROW);
	    uriMatcher.addURI("com.example.terptradingpostmessaging.provider", "profile", PROFILE_ALLROWS);
	    uriMatcher.addURI("com.example.terptradingpostmessaging.provider", "profile/#", PROFILE_SINGLE_ROW);
	}
